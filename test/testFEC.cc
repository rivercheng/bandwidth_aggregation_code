...
void TestChunk::testSendTime() {
    ...
    QCOMPARE(initialTime + PreciseTime(0, 100000) + sentTime - firstSentTime, 
...
void TestChunk::testSendTime2() {
    ...
    QCOMPARE((initialTime + PreciseTime(0, 100000) + sentTime - firstSentTime).sec,
            PreciseTime(10, 998000).sec);
    QCOMPARE((initialTime + PreciseTime(0, 100000) - firstSentTime + sentTime).usec, 
